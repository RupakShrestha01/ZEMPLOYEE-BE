                ...
                <div id="show-employee" class="col-12 content scaffold-show" role="main">
                    ...
                    <g:form resource="${this.employee}" method="DELETE">
                        <fieldset class="buttons">
                            ...
                            <g:link class="edit" action="editFeaturedImage" resource="${this.employee}"><g:message code="employee.featuredImageUrl.edit.label" default="Edit Featured Image" /></g:link>
